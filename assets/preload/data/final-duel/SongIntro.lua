...
IntroTagColor = 'FF0026'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	makeLuaText('JukeBoxText', 'Final Duel by', 300, -305-IntroTagWidth, 30)
	...
	makeLuaText('JukeBoxSubText','NexSuS', 300, -305-IntroTagWidth, 60)
